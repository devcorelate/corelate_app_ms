...
//                newFormData.setData(updatedData.getData());
    ...
    public MockAppDto fetchMockApp(String appId) {
        MockApp mockApp = mockAppRepository.findWithCertificateFieldMappingsByAppId(appId)
                .orElseThrow(() -> new ResourceNotFoundException("MockApp", "appId", appId));
    ...
    private void mapMockApp(MockAppDto mockAppDto, MockApp mockApp) {
        ...
        mockApp.setPdfTitle(mockAppDto.getPdfTitle());
        mockApp.setPdfDescription(mockAppDto.getPdfDescription());
    ...
    private MockAppDto mapMockAppDto(MockApp mockApp) {
        ...
        mockAppDto.setPdfTitle(mockApp.getPdfTitle());
        mockAppDto.setPdfDescription(mockApp.getPdfDescription());
